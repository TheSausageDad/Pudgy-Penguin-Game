...
export class PudgyGameScene extends Phaser.Scene {
  ...
  private gameOver() {
    ...
    // Remix displays its own native game-over screen in response to the
    // SDK gameOver() call above. "Play Again" is handled by the SDK
    // play_again event (see RemixUtils). No custom panel is drawn.
  }
