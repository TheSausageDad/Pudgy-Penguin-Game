...
export const TopNavBar: React.FC<TopNavBarProps> = () => {
  ...
  const handleMuteToggle = () => {
    ...
    console.log('✅ Mute Toggle: Command sent to game, dashboard state updated')
  }

  return (
    <div className="top-nav-bar">
      <div className="nav-left">
        <button className="nav-back-btn" disabled title="No previous screen in development mode">
          <svg 
      ...
      >
        <svg 
          ...
          className="nav-icon"
        >
          <title>{state.sdk.isMuted ? "sound off" : "sound on"}</title>
          {state.sdk.isMuted ? (
